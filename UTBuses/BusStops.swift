...
let wcStops = [
    ...
    CLLocationCoordinate2D(latitude: 30.290050, longitude: -97.747693), // SAN GABRIEL / 25TH',
    ...
    CLLocationCoordinate2D(latitude: 30.286465, longitude: -97.748053), // 2212 SAN GABRIEL/22ND HALF',
